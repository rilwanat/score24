    ...
    <>
      ...
      <div className='px-8 md:px-4 lg:px-16 xl:px-24 2xl:px-80 py-1 flex flex-col md:flex-row items-center justify-between'>
        <div className='flex'>          
          ...
          <div className={`flex mr-4 cursor-pointer items-center  px-2 py-1 ${currentCategory === 'Basketball' ? 'rounded-lg bg-black ' : ''}`} onClick={() => setCategory("Basketball")}><SportsBasketballIcon className='mr-2' style={{ width: '20px', height: '20px', color: currentCategory === 'Basketball' ? '#B3E94E' : '#ACBFD5' }}/> <p className={`text-xs ${currentCategory === 'Basketball' ? 'text-scGreen' : 'text-scMenuText'}`}>Basketball</p></div>
